...
try:
    ...
    mongo_client = pymongo.MongoClient(f"mongodb://{os.environ.get('MONGO_GYM_USERNAME')}:{os.environ.get('MONGO_GYM_PASSWORD')}@{os.environ.get('MONGO_ADDRESS')}:{os.environ.get('MONGO_PORT')}/{os.environ.get('MONGO_DB')}", serverSelectionTimeoutMS = 60000)
